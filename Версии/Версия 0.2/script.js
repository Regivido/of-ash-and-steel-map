...
function addIconToFilter(filterName, iconPath) {
    markerIcons[filterName] = L.icon({
        ...
        iconAnchor: [16, 32], // точка привязки (центр по горизонтали, низ по вертикали)
        popupAnchor: [0, -32], // расположение попапа
        tooltipAnchor: [10, -16] // расположение тултипа
    });
...
addIconToFilter('Бижутерия', 'assets/complite.png');
addIconToFilter('Пещеры', 'assets/complite.png');
addIconToFilter('Жуки', 'assets/beetle.png');
addIconToFilter('Записки', 'assets/complite.png');
addIconToFilter('Характеристики', 'assets/complite.png');
addIconToFilter('Квестовые предметы', 'assets/complite.png');
addIconToFilter('Ключи', 'assets/complite.png');
addIconToFilter('Книги', 'assets/complite.png');
addIconToFilter('Книги Древних', 'assets/complite.png');
...
addIconToFilter('Опасные противники', 'assets/monsters.png');
addIconToFilter('Предметы', 'assets/complite.png');
addIconToFilter('Ремесло', 'assets/complite.png');
addIconToFilter('Рецепты', 'assets/complite.png');
...
addIconToFilter('Хряк контрабандистов', 'assets/complite.png');
addIconToFilter('Мои метки', 'assets/complite.png');
...
const FiltersToggleControl = L.Control.extend({
    ...
    onAdd: function(map) {
        ...
        const filtersConfig = [
            { name: 'Все фильтры', color: '#2196F3', special: true },
            { name: 'Алтари', color: '#4CAF50' },
            { name: 'Бижутерия', color: '#4CAF50' },
            { name: 'Пещеры', color: '#4CAF50' },
            { name: 'Жуки', color: '#4CAF50' },
            { name: 'Записки', color: '#4CAF50' },
            { name: 'Характеристики', color: '#4CAF50' },
            { name: 'Квестовые предметы', color: '#4CAF50' },
            { name: 'Ключи', color: '#4CAF50' },
            { name: 'Книги', color: '#4CAF50' },
            { name: 'Книги Древних', color: '#4CAF50' },
            { name: 'Костры', color: '#4CAF50' },
            { name: 'Места для отдыха', color: '#4CAF50' },
            { name: 'Места для рыбалки', color: '#4CAF50' },
            { name: 'Неизвестно', color: '#4CAF50' },
            { name: 'НПС', color: '#4CAF50' },
            { name: 'Обелиски', color: '#4CAF50' },
            { name: 'Опасные противники', color: '#4CAF50' },
            { name: 'Предметы', color: '#4CAF50' },
            { name: 'Ремесло', color: '#4CAF50' },
            { name: 'Рецепты', color: '#4CAF50' },
            { name: 'Рудные жилы', color: '#4CAF50' },
            { name: 'Сундуки', color: '#4CAF50' },
            { name: 'Телепорты', color: '#4CAF50' },
            { name: 'Точки исследования', color: '#4CAF50' },
            { name: 'Травы', color: '#4CAF50' },
            { name: 'Хряк контрабандистов', color: '#4CAF50' },
            { name: 'Мои метки', color: '#4CAF50' }
        ];
        ...
        filtersConfig.forEach(filter => {
            ...
            const filterLabel = L.DomUtil.create('span', 'filter-label', filterGroup);
